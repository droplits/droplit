...
CKEDITOR.editorConfig = function(config) {
  ...
  */
  config.toolbar_DrupalBasic = [ ['Styles','-','Bold','Italic','-','NumberedList','BulletedList','Blockquote','-','Link','Unlink','-','Image','-','Cut','Copy','Paste','PasteText','PasteFromWord','-','Source'] ];
  ...
  config.toolbar_DrupalFull = [
      ...
      ['Cut','Cop1y','Paste','PasteText','PasteFromWord'],
